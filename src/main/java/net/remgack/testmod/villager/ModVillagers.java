package net.remgack.testmod.villager;
...
public class ModVillagers {
    ...
    public static final RegistryObject<PoiType> WEED_CROP_POI = POI_TYPES.register("weed_crop_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.WEED_CROP.get().getStateDefinition().getPossibleStates()),
                    1, 1));

    public static final RegistryObject<VillagerProfession> WEED_PLUG = VILLAGER_PROFESSIONS.register("weed_plug",
            () -> new VillagerProfession("weed_plug", x -> x.get() == WEED_CROP_POI.get(),
                    x -> x.get() == WEED_CROP_POI.get(), ImmutableSet.of(), ImmutableSet.of(),
                    SoundEvents.VILLAGER_WORK_ARMORER));
